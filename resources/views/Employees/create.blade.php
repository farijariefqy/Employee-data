    ...
    <form action="{{ route('employees.store') }}" method="POST" >
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>NIP:</strong>
                    <input type="number" name="nip" class="form-control" required="" pattern="[0-9]{16}" placeholder="NIP">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>NIK:</strong>
                    <input type="number" name="nik" class="form-control" required="" pattern="[0-9]{16}" placeholder="NIK">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="date_accepted_work" class="form-control" placeholder="Date Accepted Work">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
